...
class PLModule(lightning.LightningModule):
    def __init__(self, config):
        ...
        self.model = get_model_passt(arch=config.arch,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--experiment_name', type=str, default="PaSST")
    ...
    parser.add_argument('--roll_sec', type=float, default=0.125)  # roll waveform over time
    ...
    parser.add_argument('--window_length', type=int, default=800)  # in samples (corresponds to 25 ms)
    parser.add_argument('--hop_length', type=int, default=320)  # in samples (corresponds to 10 ms)
