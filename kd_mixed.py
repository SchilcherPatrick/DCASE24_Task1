...
from models.helpers.ensemble import MeanEnsemble, BEAEnsemble
...
class PLModule(pl.LightningModule):
    ...
    def training_step(self, train_batch, batch_idx):
        ...
        teacher_logits = self.mean_ensemble(x_cp, x_p)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--hop_length_p', type=int, default=320)  # in samples (corresponds to ~10 ms)
